...
class Locators:
    ...
    EXISTING_USER_ERROR = "//p[text()='Такой пользователь уже существует']" # Ошибка: Пользователь не существует
    SHORT_PASSWORD_ERROR = "//p[text()='Некорректный пароль']"              # Ошибка: Некорректный пароль
    # fmt: on
